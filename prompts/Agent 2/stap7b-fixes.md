# Werkgroup — Stap 7b: veilige harde opschoning

Werk verder in dezelfde worktree/branch (`fase3-werkgroup`). Niet pushen.
...
- **Geen componenten verwijderen, verplaatsen of herstructureren.** Ook de
  ongebruikte sectie-, UI- en page-editorcomponenten blijven vooralsnog als
...
- Laat de video-cacheheaders staan. `DeferredHeroVideo` is nog daadwerkelijk
  geïmporteerd door `app/blog/page.tsx` en de poster-frameassets bestaan.
- `images.remotePatterns` is al correct: geen Werkreturn-restant; niet
  aanpassen.
